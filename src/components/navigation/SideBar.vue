<template>
  <div id="view" class="h-screen flex flex-col">
    <div id="sidebar" class="relative">
      ...
      <div
        v-if="showNavigation"
        class="relative bg-white dark:bg-slate-800 h-screen w-screen md:w-60 lg:w-60 md:block shadow-xl px-3 pt-20 md:pt-6 w-30 overflow-x-hidden transition-transform duration-300 ease-in-out space-y-6 md:space-y-10"
      >
