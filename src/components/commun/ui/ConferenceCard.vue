  ...
  >
    ...
    <div class="mx-5 my-0">
      <div class="flex justify-between items-start">
        ...
        <div
          class="flex flex-col text-secondary dark:text-gray-200 text-left ml-2.5"
        >
          <h2 class="text-pretty text-md font-bold text-left leading-tight">
            {{ conference.titre }}
          </h2>
...
<script setup>
  ...
  import { getImgUrl, getTruncateText } from "@/utils/toolsBox";
