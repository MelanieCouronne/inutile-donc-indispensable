<template>
  <button
    @click="emitOnClick"
    class="w-full text-left text-sm md:text-xs font-medium text-gray-700 dark:text-gray-600 py-3 md:py-2 px-2 hover:bg-teal-500 dark:hover:bg-emerald-400 hover:text-white dark:hover:text-slate-800 rounded-md transition duration-150 ease-in-out cursor-pointer"
  >
    <p class="p-0">
      <svg
