<template>
  <div id="main-container" class="flex flex-col items-center justify-center">
    ...
    >
      <ModalSimple
        v-show="
          (isMobile && isSidebarToggled && showModal) ||
          (!isMobile && showModal)
        "
        :showCloseBtn="false"
      >
        ...
        <template #texte>
          Ci-gît la page fantôme de mon CV, où auraient dû trôner mes
          compétences légendaires, mes soft skills d'extra-terrestre et les
          détails d'une reconversion professionnelle digne d’un film
          épique...<br /><br />En attendant l'apparition miraculeuse de cette
          page, vous pouvez jeter un œil à la suite du site, ainsi qu'à mon
          profil
          <a
