<template>
  ...
  >
    <button
      ...
      class="absolute text-sm font-normal py-4 px-6 bg-teal-500 dark:bg-emerald-400 text-white dark:text-slate-800 rounded-md cursor-pointer transition ease-in-out"
    >
